                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="border border-gray-200 rounded-lg p-4">
                        ...
                        {/* Mobile Content - Changes based on current step */}
                        <div className="h-full bg-gray-50 overflow-hidden">
                          {currentStep === 0 && (
                            /* Step 0: Forms Creation */
                            <div className="p-4">
                              <div className="flex items-center justify-between mb-4">
                                <h2 className="text-lg font-bold text-gray-900">Forms</h2>
                                <button className={`bg-primary-950 text-white px-3 py-2 rounded-lg text-xs flex items-center space-x-1 ${showCreatePanel ? 'animate-pulse' : ''}`}>
                                  <Plus className="h-3 w-3" />
                                  <span>New</span>
                                </button>
                              </div>
                              ...
                              {createdForm ? (
                                <div className="bg-white border border-gray-200 rounded-lg p-3 animate-slide-in">
                                  <h3 className="font-semibold text-gray-900 text-sm mb-1">{createdForm.title}</h3>
                                  <p className="text-gray-600 text-xs mb-2">{createdForm.description}</p>
                                ...
                                <div className="text-center py-8">
                                  ...
                                  <p className="text-gray-500 text-sm">Start gathering testimonials</p>
                                </div>
                              )}
                            </div>
                          )}
                          ...
                          {currentStep === 1 && (
                            ...
                            <div className="p-4">
                              <div className="flex items-center justify-between mb-4">
                                <h2 className="text-lg font-bold text-gray-900">Custom Fields</h2>
                                <button className="bg-primary-950 text-white px-3 py-2 rounded-lg text-xs flex items-center space-x-1">
                                  <Plus className="h-3 w-3" />
                                  <span>Add</span>
                                </button>
                              </div>
                              ...
                              <div className="space-y-3">
                                {customFields.map((field, index) => (
                                  <div key={field.id} className="bg-white border border-gray-200 rounded-lg p-3 animate-slide-in">
                                    <div className="flex items-center justify-between">
                                      <div>
                                      ...
                                      <div className="flex space-x-1">
                                        <button className="p-1 text-gray-400"><ArrowUp className="h-3 w-3" /></button>
                                        <button className="p-1 text-gray-400"><ArrowDown className="h-3 w-3" /></button>
                                      </div>
                                    </div>
                                  </div>
                                ))}
                                ...
                                {customFields.length === 0 && (
                                  <div className="text-center py-6">
                                    <p className="text-gray-500 text-sm">Add custom questions beyond the standard fields</p>
                                  </div>
                                )}
                              </div>
                            </div>
                          ...
                          {currentStep === 2 && (
                            /* Step 2: Customer Form Submission */
                            <div className="bg-primary-950 text-white p-4 text-center">
                              <TestiFlowIcon className="h-6 w-6 text-white mx-auto mb-2" />
                              <h1 className="text-lg font-bold mb-1">Share Your Experience</h1>
                              <p className="text-white/90 text-xs">We'd love to hear about your experience!</p>
                              
                              <div className="bg-white text-gray-900 rounded-lg p-4 mt-4 space-y-3">
                                <div>
                                  <label className="block text-xs font-medium text-gray-700 mb-1">Rating *</label>
                                  <div className="flex justify-center space-x-1">
                                    {[1, 2, 3, 4, 5].map((star) => (
                                      <Star key={star} className={`h-5 w-5 ${star <= customerFormData.rating ? 'text-yellow-400 fill-current' : 'text-gray-300'}`} />
                                    ))}
                                  </div>
                                </div>
                                <div>
                                  <label className="block text-xs font-medium text-gray-700 mb-1">Name *</label>
                                  <input type="text" value={customerFormData.name} className="w-full px-2 py-1 border border-gray-300 rounded text-xs" readOnly />
                                </div>
                                <div>
                                  <label className="block text-xs font-medium text-gray-700 mb-1">Email *</label>
                                  <input type="email" value={customerFormData.email} className="w-full px-2 py-1 border border-gray-300 rounded text-xs" readOnly />
                                </div>
                                <div>
                                  <label className="block text-xs font-medium text-gray-700 mb-1">Testimonial *</label>
                                  <textarea rows={2} value={customerFormData.message} className="w-full px-2 py-1 border border-gray-300 rounded text-xs" readOnly />
                                </div>
                                <button className="w-full bg-secondary-500 text-white py-2 rounded-lg text-xs font-medium">
                                  Submit Testimonial
                                </button>
                          ...
                          {currentStep === 3 && (
                            /* Step 3: Testimonials Review */
                            <div className="p-4">
                              <div className="flex items-center justify-between mb-4">
                                <h2 className="text-lg font-bold text-gray-900">Testimonials</h2>
                                <select className="border border-gray-300 text-gray-700 px-2 py-1 rounded text-xs">
                              ...
                              <div className="space-y-3">
                                {testimonials.slice(0, 2).map((testimonial) => (
                                  <div key={testimonial.id} className={`bg-white border border-gray-200 rounded-lg p-3 transition-all duration-200 ${
                                    highlightedTestimonial === testimonial.id ? 'ring-2 ring-secondary-200 shadow-lg' : ''
                                  }`}>
                                    <div className="flex items-center justify-between mb-2">
                                      <div className="flex items-center space-x-2">
                                      ...
                                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                                        testimonial.status === 'approved' ? 'bg-secondary-100 text-secondary-800' : 'bg-yellow-100 text-yellow-800'
                                      }`}>
                                        {testimonial.status}
                                      </span>
                                    </div>
                                    ...
                                    <p className="text-gray-700 text-xs mb-2">"{testimonial.message.substring(0, 80)}..."</p>
                                    {testimonial.status === 'pending' && (
                                      <div className="flex space-x-1">
                                        <button className="bg-secondary-100 text-secondary-800 px-2 py-1 rounded text-xs">Approve</button>
                                        <button className="bg-red-100 text-red-800 px-2 py-1 rounded text-xs">Reject</button>
                          ...
                          {currentStep === 4 && (
                            ...
                            <div className="p-4">
                              <div className="flex items-center justify-between mb-4">
                                <h2 className="text-lg font-bold text-gray-900">Export</h2>
                                <button className="border border-gray-300 text-gray-700 px-3 py-1 rounded text-xs flex items-center space-x-1">
                                ...
                                <div>
                                  ...
                                  <div className="space-y-2">
                                    {[
                                      ...
                                      <button
                                        key={format.value}
                                        className={`w-full p-2 border rounded-lg text-left transition-colors flex items-center space-x-2 text-xs ${
                                          selectedExportFormat === format.value ? 'border-primary-500 bg-primary-50' : 'border-gray-200'
                                        }`}
                                      >
                                        <format.icon className="h-3 w-3 text-gray-600" />
