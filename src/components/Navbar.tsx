        ...
        <div className="md:hidden flex items-center space-x-2">
          ...
          <div className="flex items-center">
            <Link to={user ? "/dashboard" : "/"} className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-primary-950 max-w-[120px] truncate">TestiFlow</span>
            </Link>
          </div>
                ...
                <>
                  ...
                  <div className="px-3 py-2">
                    <button
                      ...
                      className="w-full bg-primary-950 text-white hover:bg-primary-900 py-3 px-4 rounded-md text-base font-semibold transition-colors"
